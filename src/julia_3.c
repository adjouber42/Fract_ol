...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/01/17 15:55:05 by adjouber          #+#    #+#             */
/*   Updated: 2019/01/17 15:55:06 by adjouber         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	jul_bis(t_fractol *f)
{
	...
	{
		f->jul->tmp = f->jul->zr;
		f->jul->zr = f->jul->zr * f->jul->zr - f->jul->zi * f->jul->zi - 1.476 +
			((double)f->option_x / (double)f->width);
		f->jul->zi = 2 * f->jul->zi * f->jul->tmp /
